...
#Menu2
execute if score @s 4j.musrandom matches 2 run function 4jmenu:menu/music/menu2
#Menu3
execute if score @s 4j.musrandom matches 3 run function 4jmenu:menu/music/menu3
#Menu4
execute if score @s 4j.musrandom matches 4 run function 4jmenu:menu/music/menu4
